...
- Lastly, we have the trusty "head" function in both dplyr & polars for grabbing the first 5 rows of data after the other upstream ETL takes place
...
- If you haven't heard of it, DuckDB is a zero-dependency analytical database engine that essentially let's you do data wrangling in SQL at lightning-fast speed
...
- These last two examples are no accident -- Posit is beyond all of these packages: ggplot2, plotnine, gt, and great-tables; and they have put a lot of work into structuring these packages in a way that preserves a ton of syntax similarity
